...
In una shell Unix e produce uno stream di file, chiamato in Turtle *Shell*. 
Una volta che abbiamo il nostro file RAF possiamo assumere che ci sia una Jpeg equivalente con lo stesso nome, definiamo quindi una nuova funzione pura che rimuove l'estensione RAF e aggiunge l'estensione Jpeg in fondo.
